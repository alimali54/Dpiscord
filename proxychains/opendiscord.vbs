...
shell.Run "cmd /c start """" /b ""C:\Users\Meryem\Desktop\DPI\Dpiscord\byedpi\ciadpi.exe"" --proto udp --udp-fake 2 --auto none --proto tls,http --tlsrec -2+s --auto none -p 8848", 0, False
WScript.Sleep 200
